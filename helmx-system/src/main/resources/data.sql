...
FROM (
  SELECT 1 AS role_id, 1 AS menu_id UNION ALL SELECT 1,2 UNION ALL SELECT 1,3 UNION ALL SELECT 1,4 UNION ALL SELECT 1,6 UNION ALL SELECT 1,7 UNION ALL SELECT 1,8 UNION ALL SELECT 1,9 UNION ALL SELECT 1,10 UNION ALL SELECT 1,11 UNION ALL SELECT 1,12 UNION ALL SELECT 1,13 UNION ALL SELECT 1,14 UNION ALL SELECT 1,23 UNION ALL SELECT 1,24 UNION ALL SELECT 1,25 UNION ALL SELECT 1,26 UNION ALL SELECT 1,27 UNION ALL SELECT 1,28 UNION ALL SELECT 1,29 UNION ALL SELECT 1,30 UNION ALL SELECT 1,31 UNION ALL SELECT 1,32 UNION ALL SELECT 1,33 UNION ALL SELECT 1,34 UNION ALL SELECT 1,36 UNION ALL SELECT 1,37 UNION ALL SELECT 1,38 UNION ALL SELECT 1,39 UNION ALL SELECT 1,40 UNION ALL SELECT 1,41 UNION ALL SELECT 1,42 UNION ALL SELECT 1,43 UNION ALL SELECT 1,44 UNION ALL SELECT 1,45 UNION ALL SELECT 1,46 UNION ALL SELECT 1,47 UNION ALL SELECT 1,48 UNION ALL SELECT 1,49 UNION ALL SELECT 1,50 UNION ALL SELECT 1,51 UNION ALL SELECT 1,52 UNION ALL SELECT 1,53 UNION ALL SELECT 1,54 UNION ALL SELECT 1,55 UNION ALL SELECT 1,56 UNION ALL SELECT 1,57 UNION ALL SELECT 1,58 UNION ALL SELECT 1,59 UNION ALL SELECT 1,60 UNION ALL SELECT 1,61 UNION ALL SELECT 1,62 UNION ALL SELECT 1,63 UNION ALL SELECT 1,64 UNION ALL SELECT 1,65 UNION ALL SELECT 1,66 UNION ALL SELECT 1,67 UNION ALL SELECT 1,68 UNION ALL SELECT 1,69 UNION ALL SELECT 1,70 UNION ALL SELECT 1,71 UNION ALL SELECT 1,72 UNION ALL SELECT 1,73 UNION ALL SELECT 1,74 UNION ALL SELECT 1,75 UNION ALL SELECT 1,76 UNION ALL SELECT 1,77 UNION ALL SELECT 1,78 UNION ALL SELECT 1,79 UNION ALL SELECT 1,80 UNION ALL SELECT 1,81 UNION ALL SELECT 1,82 UNION ALL SELECT 1,83 UNION ALL SELECT 1,84 UNION ALL SELECT 1,85 -- 超级管理员拥有所有菜单权限
  UNION ALL SELECT 2,1 UNION ALL SELECT 2,2 UNION ALL SELECT 2,3 UNION ALL SELECT 2,4 UNION ALL SELECT 2,6 UNION ALL SELECT 2,7 UNION ALL SELECT 2,9 UNION ALL SELECT 2,10 UNION ALL SELECT 2,12 UNION ALL SELECT 2,13 UNION ALL SELECT 2,23 UNION ALL SELECT 2,24 UNION ALL SELECT 2,25 UNION ALL SELECT 2,26 UNION ALL SELECT 2,27 UNION ALL SELECT 2,28 UNION ALL SELECT 2,32 UNION ALL SELECT 2,33 UNION ALL SELECT 2,34 UNION ALL SELECT 2,36 UNION ALL SELECT 2,37 UNION ALL SELECT 2,38 UNION ALL SELECT 2,39 UNION ALL SELECT 2,40 UNION ALL SELECT 2,41 UNION ALL SELECT 2,42 UNION ALL SELECT 2,43 UNION ALL SELECT 2,44 UNION ALL SELECT 2,45 UNION ALL SELECT 2,46 UNION ALL SELECT 2,47 UNION ALL SELECT 2,48 UNION ALL SELECT 2,49 UNION ALL SELECT 2,50 UNION ALL SELECT 2,51 UNION ALL SELECT 2,52 UNION ALL SELECT 2,53 UNION ALL SELECT 2,54 UNION ALL SELECT 2,55 UNION ALL SELECT 2,65 UNION ALL SELECT 2,66 UNION ALL SELECT 2,67 UNION ALL SELECT 2,68 UNION ALL SELECT 2,69 UNION ALL SELECT 2,70 UNION ALL SELECT 2,71 UNION ALL SELECT 2,72 UNION ALL SELECT 2,73 UNION ALL SELECT 2,74 UNION ALL SELECT 2,75 UNION ALL SELECT 2,76 UNION ALL SELECT 2,77 UNION ALL SELECT 2,78 UNION ALL SELECT 2,79 UNION ALL SELECT 2,80 UNION ALL SELECT 2,81 UNION ALL SELECT 2,82 UNION ALL SELECT 2,83 UNION ALL SELECT 2,84 UNION ALL SELECT 2,85 -- 管理员
  UNION ALL SELECT 3,1 UNION ALL SELECT 3,2 UNION ALL SELECT 3,3 UNION ALL SELECT 3,4 UNION ALL SELECT 3,23 UNION ALL SELECT 3,24 UNION ALL SELECT 3,25 UNION ALL SELECT 3,26 UNION ALL SELECT 3,27 UNION ALL SELECT 3,28 UNION ALL SELECT 3,68 -- 普通用户
) tmp
